...
const styles = StyleSheet.create({
  ...
  hero: {
    borderWidth: 1, borderRadius: 16, padding: 16, marginBottom: 12, overflow: 'hidden',
  ...
  categoryBadge: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: '#EEF2FF', paddingHorizontal: 10, paddingVertical: 5, borderRadius: 14 },
  categoryText: { color: '#4338CA', fontWeight: '800', fontSize: 12 },
  ...
  primaryButton: { backgroundColor: '#4F46E5', borderRadius: 14, paddingVertical: 14, alignItems: 'center' },
  ...
  manageButton: { backgroundColor: '#EEF2FF', borderRadius: 14, paddingVertical: 12, alignItems: 'center', marginTop: 8 },
  manageButtonText: { color: '#4338CA', fontSize: 14, fontWeight: '900' },
